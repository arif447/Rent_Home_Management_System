...
class Add_Flat(models.Model):
    ...
    Bedroom = models.CharField(max_length=250, blank=True, null=True)
    Guest_room = models.IntegerField(blank=True, null=True)
    Number_of_bath = models.CharField(max_length=250, blank=True, null=True)
    Number_of_balcony = models.CharField(max_length=250, blank=True, null=True)
