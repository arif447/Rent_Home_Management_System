...
class BillingInfo(models.Model):
    ...
    Bkash = 3
    Nagad = 4
    billing_user = models.ForeignKey(CreateUser, related_name="billing_user", on_delete=models.CASCADE )
    flat = models.ForeignKey(Add_Flat, on_delete=models.CASCADE, related_name="billing_flat", blank=True, null=True)
    # billing_date = models.DateField(blank=True, null=True)
    # billing_time = models.TimeField(blank=True, null=True)
    ...
    payment_method = models.PositiveSmallIntegerField(choices=payment_method_choise)
    ...
    billing_status = models.CharField(
        max_length=20, choices=billing_status_choise, default=Pending, blank=True, null=True)
...
class BankInfo(models.Model):
    bank_info_user = models.ForeignKey(CreateUser, on_delete=models.CASCADE, related_name='bank_info_user')
